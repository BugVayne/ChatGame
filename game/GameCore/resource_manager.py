...
class ResourceManager:
    ...
    def load_image(self, filename):
        ...
        try:
            ...
            if img.get_width() != GameConfig.CELL_SIZE:
                img = pygame.transform.scale(img, (GameConfig.CELL_SIZE, GameConfig.CELL_SIZE))
    ...
    def create_surface(self, color, width=64, height=64, circle=False):
        ...
        if circle:
            ...
            pygame.draw.circle(surf, (0, 0, 0), (width // 2, height // 2), width // 2 - 2, 2)
        else:
    ...
    def create_placeholder(self, color, frames=2, circle=False):
        ...
        for i in range(frames):
            ...
            shade = (min(255, color[0] + i * 10), min(255, color[1] + i * 10), min(255, color[2] + i * 10))
